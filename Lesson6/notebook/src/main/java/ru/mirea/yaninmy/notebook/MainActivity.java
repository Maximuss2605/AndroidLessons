...
package ru.mirea.yaninmy.notebook;
        ...
        btnLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast toast = Toast.makeText(getApplicationContext(), "Считывание файла успешно выполнено!", Toast.LENGTH_SHORT);
                    toast.show();
                } catch (Exception e) {
                    Log.w("ExternalStorage", String.format("Read from file %s failed", e.getMessage()));
                    Toast toast = Toast.makeText(getApplicationContext(), "Считывание файла провалено", Toast.LENGTH_SHORT);
                    toast.show();
                }
            }
        });
