package ru.mirea.yaninmu.toastapp;
...
public class ToastAppMain extends AppCompatActivity {
    EditText editText;
    TextView textView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_toast_app_main);
        ConstraintLayout constraintLayout = new ConstraintLayout(this);
        textView = new TextView(this);
        textView.setId(View.generateViewId());
        ConstraintLayout.LayoutParams textViewLayout = new ConstraintLayout.LayoutParams(ConstraintLayout.LayoutParams.MATCH_CONSTRAINT, ConstraintLayout.LayoutParams.WRAP_CONTENT);
    ...
    buttonLayout.leftToLeft = ConstraintLayout.LayoutParams.PARENT_ID;
        ...
        public void onClick(View v) {
            textView.setText("СТУДЕНТ номер 30 ГРУППА БСБО-17-20 Количество символов — " + editText.getText().length());
        }
    });
